...
class Car {
    ...
    wrapAngle(angle) {
        angle > 360 ? angle = angle - 360 : angle < 0 ? angle = angle + 360 : angle;
        return angle;
    }
    ...
    update() {
        this.controlPressed[0] ? this.accelerate() :
            this.controlPressed[1] ? this.breake() :
            this.friction();
...
var cars = [
    new Car("lambo", "cars/car2.png", 180, 1.5, 0.005, 0.02, 2, 45, "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"),
    new Car("merci", "cars/car1.png", 180, 1.5, 0.007, 0.02, 2.3, 48, "KeyW", "KeyS", "KeyA", "KeyD")
];
